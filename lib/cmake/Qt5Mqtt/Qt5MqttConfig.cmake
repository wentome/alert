...
if (NOT TARGET Qt5::Mqtt)
    ...
    set(Qt5Mqtt_PRIVATE_INCLUDE_DIRS
        "${_qt5Mqtt_install_prefix}/include/QtMqtt/5.9.0"
        "${_qt5Mqtt_install_prefix}/include/QtMqtt/5.9.0/QtMqtt"
    )
    ...
    _populate_Mqtt_target_properties(RELEASE "Qt5Mqtt.dll" "libQt5Mqtt.a" )



    _populate_Mqtt_target_properties(DEBUG "Qt5Mqttd.dll" "libQt5Mqttd.a" )
